    ...
    <div className={`relative min-h-screen flex flex-col items-center justify-center px-8 overflow-hidden transition-colors duration-300 ${
      ...
      <div className="relative z-10 text-center mb-20">
        ...
        <div className="mt-5 flex items-center justify-center gap-3">
          <span className={`text-base font-mono font-bold tracking-widest ${isDark ? 'text-white' : 'text-slate-800'}`}>
            Sedef Korkmaz
          </span>
          ...
          <div
            ...
            style={{
              background: isDark
                ...
                : 'radial-gradient(ellipse 120% 80% at 0% 0%, rgba(8,145,178,0.05) 0%, transparent 65%)',
            }}
          />

          <div className={`w-12 h-12 mb-6 rounded-xl border flex items-center justify-center ${
          ...
          <div
            ...
            style={{
              background: isDark
                ...
                : 'radial-gradient(ellipse 120% 80% at 0% 0%, rgba(249,115,22,0.05) 0%, transparent 65%)',
            }}
          />
